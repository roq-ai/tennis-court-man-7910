...
import { getTennisCourtById } from 'apiSdk/tennis-courts';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Tennis Court Detail View
          </Text>
          {hasAccess('tennis_court', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/tennis-courts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/bookings/create?tennis_court_id=${data?.id}`}>
